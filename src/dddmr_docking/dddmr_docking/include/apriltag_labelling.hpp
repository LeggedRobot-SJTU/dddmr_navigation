#ifndef DDDMR_DOCKING__APRILTAG_LABELLING_HPP_
#define DDDMR_DOCKING__APRILTAG_LABELLING_HPP_
...
class AprilTagLabelling : public rclcpp::Node {
public:
  explicit AprilTagLabelling(const std::string &name);
  ~AprilTagLabelling();
...
#endif // DDDMR_DOCKING__APRILTAG_LABELLING_HPP_
